...
<div class="grid grid-cols-3 gap-4 mb-6">
    ...
    <div class="admin-stat" style="border-top:3px solid #d946ef"><div class="admin-stat-label">En progreso</div><div class="admin-stat-value"><?= number_format($stats['in_progress']) ?></div></div>
