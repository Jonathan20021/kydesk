    ...
    <nav class="fixed top-4 inset-x-0 z-50 px-4">
        <div class="max-w-[1100px] mx-auto">
            <div class="flex items-center justify-between gap-4 px-5 py-2.5 rounded-full" style="background:rgba(255,255,255,0.78);backdrop-filter:blur(20px) saturate(180%);border:1px solid rgba(124,92,255,0.12);box-shadow:0 4px 20px -4px rgba(22,21,27,0.06)">
                ...
                <a href="<?= $url('/auth/register') ?>" class="text-[13px] font-semibold text-ink-700 hover:text-brand-700 transition">Crear cuenta →</a>
            </div>
        </div>
    </nav>
        ...
        <div class="w-full max-w-[1100px] grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div class="hidden lg:block">
                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-[11px] font-bold uppercase tracking-[0.16em]" style="background:rgba(255,255,255,.85);border:1px solid rgba(124,92,255,0.2);color:#5a3aff">
                    <i class="lucide lucide-sparkles text-[12px]"></i> BIENVENIDO DE VUELTA
                </div>

                <h1 class="display-xl mt-7" style="font-size:clamp(2.4rem,4vw + 1rem,4rem);text-wrap:balance">Una plataforma.<br><span class="gradient-shift">Todo tu soporte</span>.</h1>

                <p class="mt-6 text-[16px] text-ink-500 max-w-md leading-relaxed">Tickets, SLAs, escalamientos, automatizaciones y conocimiento — todo donde tu equipo lo encuentra.</p>

                <div class="mt-10 space-y-3">
                    <?php foreach ([['zap','Atajos de teclado en todas partes'],['shield-check','Seguro y auditado'],['workflow','Automatizaciones nativas']] as [$ic,$t]): ?>
                ...
                <div class="mt-12 flex items-center gap-3 p-4 rounded-2xl" style="background:rgba(255,255,255,.6);backdrop-filter:blur(8px);border:1px solid rgba(124,92,255,0.15)">
                    ...
                    <div class="flex-1 text-[12.5px] text-ink-700">
                        <div class="font-display font-bold">+12,000 técnicos</div>
                        <div class="text-ink-400">resuelven con Kydesk</div>
                    </div>
                </div>
            </div>
            ...
            <div class="relative">
                ...
                <div class="relative rounded-[28px] p-8 md:p-10" style="background:white;border:1px solid #ececef;box-shadow:0 30px 60px -20px rgba(124,92,255,0.18)">
                    ...
                    <div class="text-[11px] font-bold uppercase tracking-[0.16em] text-brand-600 mb-2">Iniciar sesión</div>
                    <h2 class="font-display font-extrabold text-[28px] tracking-[-0.025em] leading-tight">Bienvenido<br>de vuelta</h2>
                    <p class="mt-2 text-[13.5px] text-ink-500">Ingresa a tu workspace de Kydesk</p>
                    ...
                    <form method="POST" action="<?= $url('/auth/login') ?>" class="mt-7 space-y-4">
                        ...
                        <div x-data="{show:false}">
                            <div class="flex items-center justify-between">
                                <label class="label" style="margin-bottom:0">Contraseña</label>
                                <a href="#" class="text-[12px] text-brand-700 font-medium hover:underline">¿Olvidaste?</a>
                            </div>
                    ...
                    <p class="mt-7 text-center text-[13px] text-ink-400">¿Nuevo en Kydesk? <a href="<?= $url('/auth/register') ?>" class="font-semibold text-brand-700 hover:underline">Crear organización</a></p>
                </div>
            </div>
        </div>
    </div>
