...
class LandingController extends Controller
{
    public const FEATURES = [
        ...
        'ai_assist' => [
            'title' => 'IA Asistente · Claude',
            'tagline' => 'Sugerir respuesta, resumir, clasificar, sentiment, traducir · Plan Enterprise',
            'icon' => 'sparkles',
            'color' => '#a78bfa',
            'bg' => '#f3e8ff',
            'category' => 'IA & WORKFLOWS',
            'hero_kpis' => [['Modelo', 'Claude 4.5'], ['Acciones', '5 builtins'], ['Disponible', 'Enterprise']],
            'description' => 'IA Asistente con Claude (Anthropic) integrado al flujo de tickets. Sugerí respuestas a partir del contexto, resumí hilos largos en 4 líneas, auto-categorizá tickets, detectá sentiment del cliente y traducí entre idiomas — todo con un click. La API key vive en el lado de Kydesk: tu equipo nunca toca billing del proveedor.',
            'steps' => [
                ['Kydesk activa la IA', 'El equipo de Kydesk asigna IA a tu workspace Enterprise con cuota mensual. Sin manejar API keys.', 'shield-check'],
                ...
                ['1-click en cada ticket', 'Botones "Sugerir respuesta" o "Resumir" en cada ticket — Claude responde en segundos con tu contexto.', 'zap'],
            ],
            'benefits' => [
                ...
                ['tag','Auto-categorizar','Claude propone categoría y prioridad analizando el contenido. Acelera la entrada.'],
            ...
            'mockup' => 'ai_assist',
            'faqs' => [
                ['¿Quién paga el costo del proveedor de IA?','Kydesk gestiona la API key y absorbe el costo dentro del plan Enterprise. Sin sorpresas en tu factura.'],
                ['¿Hay límite de uso?','Cuota mensual configurable por tenant. Si necesitás más, contactá al equipo de Kydesk para upgrade.'],
                ['¿Qué modelo usa?','Por defecto Claude Haiku (rápido y económico). Configurable a Sonnet o Opus si requerís más calidad.'],
                ['¿Mis datos se usan para entrenar?','No. Anthropic no entrena con prompts de la API. Tus tickets quedan privados.'],
                ['¿En qué planes está disponible?','Solo Enterprise. Kydesk asigna IA explícitamente a cada tenant Enterprise tras revisión.'],
            ],
        ],
        'csat' => [
            'title' => 'CSAT / NPS',
